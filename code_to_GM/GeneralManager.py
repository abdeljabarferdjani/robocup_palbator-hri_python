...
from scenario.testThomas_Receptionist2020CPEScenario import Receptionist2020CPEScenario
# Command Samples
...
class GeneralManager:
    ...
    def configure(self, config):
        ...
        self._scenarioMap = dict(COCKTAIL_PARTY=CocktailPartyScenario,
                                 ...
                                 RECEPTIONIST_2020_CPE=Receptionist2020CPEScenario)
    ...
    #######################################################################
    def loadConfig(self):
        rospy.logwarn("GM : SCENARIO NAME "+self.CURRENT_SCENARIO)
