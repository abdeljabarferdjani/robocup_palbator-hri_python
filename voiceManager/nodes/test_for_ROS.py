...
class TestROS(object):
    ...
    def publisher(self):
        ...
        x={u'name': u'Wait', u'order': 6, u'eta': 0, u'speech': {u'said': u"Did you say your name was John?", u'title': u"I'm waiting for the referee"}, u'arguments': {u'time': 3}, u'action': u'confirm', u'id': u'findg1_wait'}
